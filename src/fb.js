...
var _require = require('../package.json'),
	...
	for (var key in params) {
		...
		if (value && typeof value !== 'string') {
			...
			var val = (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) === 'object' && (_context = value, has).call(_context, 'value') && (_context = value, has).call(_context, 'options') ? value.value : value;
